...
namespace KeyProtectedAPIEndpoints
{
    ...
    {
        private static readonly IDictionary<string, ApiKey> apiKeys = new Dictionary<string, ApiKey>();
        public int GetNextId => apiKeys.Count + 1;
        ...
        public InMemoryGetApiKeyQuery()
        {
            ...
            foreach (ApiKey key in existingApiKeys)
            {
                AddKey(key);
            }
        }
        ...
        {
            apiKeys.TryAdd(apiKey.Key, apiKey);
        }
